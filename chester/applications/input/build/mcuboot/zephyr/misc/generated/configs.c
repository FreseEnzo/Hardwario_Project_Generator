...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_HCI_VSC_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_BATTERY_LOG_LEVEL, 0);
